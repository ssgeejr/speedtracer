 ...
 * monitoring.
 */
public class HeadlessClearDataMessage extends Message {
  public static final int TYPE = MessageType.PORT_HEADLESS_CLEAR_DATA;

  protected HeadlessClearDataMessage() {
  }
}
